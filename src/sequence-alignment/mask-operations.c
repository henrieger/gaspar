...
void maskUnion(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
  ...
  int avx2sInSequence = allowedArraySize() / sizeof(__m256i_u);
...
void maskUnion(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
  ...
  int avx512sInSequence = allowedArraySize() / sizeof(__m512i_u);
...
void maskUnion(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
  ...
  int longsInSequence = allowedArraySize() / sizeof(uint64_t);
