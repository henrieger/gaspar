...
void maskUnion_64(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
  ...
  int longsInSequence = ceilDiv(allowedArraySize(characters), sizeof(uint64_t));
...
void maskUnion_256(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
  ...
  int avx2sInSequence =
      ceilDiv(allowedArraySize(characters), sizeof(__m256i_u));
...
void maskUnion_512(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
  ...
  int avx512sInSequence =
      ceilDiv(allowedArraySize(characters), sizeof(__m512i_u));
...
void maskUnion(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
               stateAllowedMask_t *mask2, uint32_t characters) {
  return maskUnion_256(result, mask1, mask2, characters);
}

void maskIntersection(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
                      stateAllowedMask_t *mask2, uint32_t characters) {
  return maskIntersection_256(result, mask1, mask2, characters);
}

void maskNot(stateAllowedMask_t *result, stateAllowedMask_t *mask,
             uint32_t characters) {
  return maskNot_256(result, mask, characters);
}
#elif AVX512_CHARACTERS == 1
void maskUnion(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
               stateAllowedMask_t *mask2, uint32_t characters) {
  return maskUnion_512(result, mask1, mask2, characters);
}

void maskIntersection(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
                      stateAllowedMask_t *mask2, uint32_t characters) {
  return maskIntersection_512(result, mask1, mask2, characters);
}

void maskNot(stateAllowedMask_t *result, stateAllowedMask_t *mask,
             uint32_t characters) {
  return maskNot_512(result, mask, characters);
}
#else
void maskUnion(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
               stateAllowedMask_t *mask2, uint32_t characters) {
  return maskUnion_64(result, mask1, mask2, characters);
}

void maskIntersection(stateAllowedMask_t *result, stateAllowedMask_t *mask1,
                      stateAllowedMask_t *mask2, uint32_t characters) {
  return maskIntersection_64(result, mask1, mask2, characters);
}

void maskNot(stateAllowedMask_t *result, stateAllowedMask_t *mask,
             uint32_t characters) {
  return maskNot_64(result, mask, characters);
}
#endif
